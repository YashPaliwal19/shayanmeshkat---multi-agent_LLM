...
def run_experiment(world, alg_name, experiment_known, experiment_learned, num_times, show_print, show_plots, al_alg_name, sat_alg_name, pysat_hints=None, prompt_file=None, messages=None):
    ...
    if alg_name == "jirp":
        messages = []
        run_aqrm_experiments(alg_name, testing_params, tester, tester_l, curriculum, num_times, show_print, show_plots, al_alg_name, sat_alg_name, pysat_hints, prompt_file, messages)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pysat_prompt", "--prompt_file", action='append',
                        help='This parameter indicated allows for the initial prompt to be assgined')
    ...
    if args.pysat_prompt is None:
        prompt_file = None
    else:
        prompt_file = args.pysat_prompt
        print('prompt in run1.py:', args.pysat_prompt)
    ...
    run_experiment(world, alg_name, experiment_t, experiment_l, num_times, show_print, show_plots, al_alg_name, sat_alg_name, pysat_hints, prompt_file)
